//
//  HCVideoConsultViewController.swift
//  HuChuangApp
//
...
class HCVideoConsultViewController: HCSlideItemController {
...
extension HCVideoConsultViewController: UITableViewDelegate, UITableViewDataSource {
